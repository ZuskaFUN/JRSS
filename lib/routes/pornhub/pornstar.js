        ...
        item:
            ...
            list
                .map((_, e) => {
                    ...
                    title_path = e.find('span.title a');
                    title_text = title_path.text();
                    item_link = mainweb + title_path.attr('href');
                    ...
                    return {
                        ...
                        enclosure_url: mainweb + `/embed/` + item_link.substring(item_link.lastIndexOf("=") + 1),
